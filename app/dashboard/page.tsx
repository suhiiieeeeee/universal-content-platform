...
export default async function DashboardOverviewPage() {
  ...
  return <div className="flex flex-1 flex-col">
    <DashboardHeader title={`Welcome back${profile?.display_name ? `, ${profile.display_name}` : ""}`} description="Your files and collections, in one focused dashboard." profile={profileForHeader} actions={<NewFileDialog />} />
